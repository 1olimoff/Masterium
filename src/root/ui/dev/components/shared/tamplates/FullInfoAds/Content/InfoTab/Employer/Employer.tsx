    ...
    <section className={cn("w-full flex flex-col gap-2", className)}>
      ...
      <div className="flex items-center gap-3 border-b border-[#CFD9FE] pb-4">
        ...
        <div className="flex flex-col justify-center">
          <h4 className="text-lg font-semibold">{detail.user.first_name} {detail.user.last_name}</h4>
          <p className="text-sm text-maket-gray">
            {t("WorksPage.content.employer.period.title")} {new Date(detail.user.created_at).getFullYear()}  {""}
