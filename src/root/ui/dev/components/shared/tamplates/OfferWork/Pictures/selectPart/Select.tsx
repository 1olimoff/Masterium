...
export default function CustomInputFile({ onFilesAdd }: Props) {
    ...
    return (
        <div className="flex flex-row items-center ">
            <label
                className="text-sm font-medium w-[180px] h-[120px] text-gray-700 border-2 border-dashed border-gray-300 rounded-[13px] flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50"
            >
                <input
                    type="file"
                    accept="image/*"
