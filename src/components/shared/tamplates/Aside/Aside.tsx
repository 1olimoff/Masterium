...
const Aside = ({className}: Props) => {
    return (
        <aside
            className={cn(className, "py-3 px-2 shadow bg-white sticky top-0 flex justify-between items-center gap-8 layout-width")}>
            <div>
            ...
            <div className={"flex justify-between items-center gap-4 flex-1"}>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        <DropdownMenuItem><Image src={'/svg/aside/tech.svg'} alt={'Tech Icon'} width={18} height={18} />Santehniklar</DropdownMenuItem>
                        <DropdownMenuItem><Image src={'/svg/aside/tech.svg'} alt={'Tech Icon'} width={18} height={18} />Santehniklar</DropdownMenuItem>
                        <DropdownMenuItem><Image src={'/svg/aside/tech.svg'} alt={'Tech Icon'} width={18} height={18} />Santehniklar</DropdownMenuItem>
                        <DropdownMenuItem><Image src={'/svg/aside/tech.svg'} alt={'Tech Icon'} width={18} height={18} />Santehniklar</DropdownMenuItem>
                        <DropdownMenuItem><Image src={'/svg/aside/tech.svg'} alt={'Tech Icon'} width={18} height={18} />Santehniklar</DropdownMenuItem>
